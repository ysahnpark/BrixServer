...
module.exports = function(config) {
	...
	if (config.hubProxy)
	{
		// You may override the default one. Useful when testing with mock.
		hubProxy_ = config.hubProxy; 
	}
	else
	{
		hubProxy_ = new HubProxy(config);
	}

	var sequenceNodeProvider_ = null;
	if (config.sequenceNodeProvider)
	{
		// You may override the default one. Useful when testing with mock.
		sequenceNodeProvider_ = config.sequenceNodeProvider; 
	}
	else
	{
		sequenceNodeProvider_ = new SequenceNodeProvider(config);
	}
	/**
