...
/*
	...
	{
		var that = this;
		this.sequenceNodeProvider.getSequenceNodeByKey(data.sequenceNodeKey, function(gsnError, sequenceNode){
			...
			else
			{
				...
				/* @todo: si -
					...
					- pull the answerKey and assessmentType out of sequenceNode
