...
/*
	...
	/**
	 * Extracts a specific container config from the sequence node content.
	 * @param  {Object} targetActivity  The entire value of the target activity
	 *                                  property from the sequence node content 
	 * @param  {string} containerId     The id of the container to extract. Aka. targetId, but not to get confused with the PAF's targetActivity
	 * @return {Object}                 The container config with the id. 
	 *                                  Null if not found
	 */
	function obtainContainer_(targetActivity, containerId)
	{
	...
	/**
	 * Extracts the answer part from the Sequence Node Content.
	 * It is used when invoking the Correctness Engine to get feedback to an answer.
	 * 
	 * @param  {Object} targetActivity The entire value of the target activity
	 *                                  property from the sequence node content 
	 * 
	...
	function obtainAnswerPart_(targetActivity, opt_containerId)
	{
		...
		if (opt_containerId)
		{
			var containerItem = obtainContainer_(targetActivity, opt_containerId);
	...
	this.obtainContainer__ = obtainContainer_;
