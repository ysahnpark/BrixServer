        ...
        this.sequenceNodeProvider.getSequenceNode(sequenceNodeIdentifier, function(err, body)  {
            ...
            if (err !== null) {
                ...
                var sanitizedBrixConfig = {
                    ...
                    maxAttempts: body.sequenceNodeContent.maxAttempts
                };
...
//console.log("--**-1-" + JSON.stringify(nodeResult));
    ...
    this.postSubmission = function(data, callback)
    {
        ...
        .then(function(seqNodeInfo){
            ...
            .then(function(result){
                // Build the NodeResult from the CE result
                var nodeResult = buildSubmissionNodeResult_(result, studentSubmission, seqNodeInfo.itemCorrelationToken);
                ...
                if (cePayload.answerKey.nonRecordable === undefined ||
                    cePayload.answerKey.nonRecordable === null ||
                    cePayload.answerKey.nonRecordable === false)
                {
     ...
     */
    function buildSubmissionNodeResult_(result, studentSubmission, itemCorrelationToken)
    {
        ...
        _.extend(nodeResult,
            {
                //just be careful around there, because how many attempts the student has done is calculated by counting the nodeResult elements we have in cache, but that count is done before the creation of the nodeResult the student is currently on. most of my code could be classified as "almost code" "barely code" or "you call that code?" would also be acceptable.
