...
//console.log("ERR " + error + " RES " + JSON.stringify(result));
    ...
    function buildSubmissionNodeResult_(result, studentSubmission)
    {
        ...
        // @todo -
        // * consider logging
        // * do we need a separate function for buildInteractiveNodeResult_
        // * research responseVariable(s)
        // * look through your drive docs to see if there are other outstanding questions
        // * I need to test this in an integration path kinda way
        // * and it'd be cool to test this in an integration path kinda way without a CE Mock
