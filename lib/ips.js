...
module.exports = function(config) {
	...
	this.retrieveSequenceNode = function(payload, callback) {
		...
		sequenceNodeProvider_.getSequenceNode(sequenceNodeIdentifier, function(err, body)  {
			if (err !== null) {
				callback(err, body);
			} else {
...
/*
	...
	function updateCache_(data, result)
	{
		if (data && result)
		{
			sequenceNodeProvider_.updateSequenceNodeInCache(data.sequenceNodeKey, data, function(err, updateResult)  {
				if (err !== null) {
